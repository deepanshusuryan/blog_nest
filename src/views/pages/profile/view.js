        ...
        <div className="profile-root">
            ...
            <aside className="profile-sidebar">
                ...
                <div className="sidebar-user">
                    ...
                    <span className="sidebar-user-name">{user?.name || "Anonymous"}</span>
            ...
            <main className="profile-main">
                ...
                <div className="profile-page-heading">
                    <h1>Your <em style={{ fontStyle: "italic", color: "var(--color-amber)" }}>Nest</em></h1>
                ...
                <div className="profile-hero-card">
                    ...
                    <div className="profile-hero-info">
                        ...
                        <h2 className="profile-name">{user?.name || "Anonymous Writer"}</h2>
                    ...
                    >
                        {editing ? <><IconCheck /> Done</> : <><IconEdit /> Edit Profile</>}
                    </button>
                </div>
                ...
                <div className="profile-grid">
                    ...
                    <div className="profile-card profile-details-card">
                        ...
                        <div className="profile-fields">
                            <FieldRow label="Full name"  name="name"     value={user?.name}     icon={<IconUser />}  editing={editing} />
                            <FieldRow label="Username"   name="username" value={user?.username}  icon={<IconUser />}  editing={editing} />
                            <FieldRow label="Email"      name="email"    value={user?.email}     icon={<IconMail />}  editing={editing} />
                            <FieldRow label="Contact"    name="contact"  value={user?.contact}   icon={<IconPhone />} editing={editing} />
                        </div>
                        {editing && (
